...
function mostrarAlerta(mensaje) {
    ...
    if (!existeAlerta) {
        ...
        alerta.classList.add('bg-red-100', 'border-red-400', 'border', 'text-red-700', 'px-4', 'py-3', 'rounded', 'max-w-lg', 'mx-auto', 'mt-6', 'text-center');
        alerta.innerHTML = `
...
function mostrarImagenes(imagenes) {
    ...
    // iterar sobre el arreglos de imagenes y construir el html
